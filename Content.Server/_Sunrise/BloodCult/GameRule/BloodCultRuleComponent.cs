...
public sealed partial class BloodCultRuleComponent : Component
{
    ...
    /// <summary>
    /// 🌇Sunset🌇 - guards BloodCultRuleSystem.OnRunLevelChanged so cult targets are only picked once
    /// (this fork has no AntagSelectionCompleteEvent, so target population moved to
    /// GameRunLevelChangedEvent -> InRound instead).
    /// </summary>
    [DataField]
    public bool TargetsPopulated;
}
