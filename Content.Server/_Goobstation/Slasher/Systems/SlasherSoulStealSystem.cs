...
/// Goob-Station also slaps a random devil contract clause on the victim; this fork has no devil, so that is skipped.
/// </summary>
    ...
    private void OnSoulStealDoAfterComplete(Entity<SlasherSoulStealComponent> ent, ref SlasherSoulStealDoAfterEvent ev)
    {
            ...
            && totalSouls >= comp.AscendanceSoulThreshold)
        {
            ...
            if (station != null)
            {
                ...
                // Goob-Station also kicks off a "Storm" weather prototype here.
                // This fork ships no such weather prototype, so that part is dropped.
