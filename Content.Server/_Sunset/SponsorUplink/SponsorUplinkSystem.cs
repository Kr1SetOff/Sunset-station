...
public sealed class SponsorUplinkSystem : EntitySystem
{
    ...
    {
        // Civilian
        ["Clown"] = "SponsorUplinkDeptCivilian",
        ["Assistant"] = "SponsorUplinkDeptCivilian",
        ["Lawyer"] = "SponsorUplinkDeptCivilian",
        ["Mime"] = "SponsorUplinkDeptCivilian",
        ["Bartender"] = "SponsorUplinkDeptCivilian",
        ["Chef"] = "SponsorUplinkDeptCivilian",
        ["Janitor"] = "SponsorUplinkDeptCivilian",
        ["ServiceWorker"] = "SponsorUplinkDeptCivilian",
        ["Librarian"] = "SponsorUplinkDeptCivilian",
        ["Musician"] = "SponsorUplinkDeptCivilian",
        ["Reporter"] = "SponsorUplinkDeptCivilian",
        ["Performer"] = "SponsorUplinkDeptCivilian",
        ["Boxer"] = "SponsorUplinkDeptCivilian",
        ["Zookeeper"] = "SponsorUplinkDeptCivilian",
        ["Botanist"] = "SponsorUplinkDeptCivilian",
        ["Chaplain"] = "SponsorUplinkDeptCivilian",
        // Security
        ["HeadOfSecurity"] = "SponsorUplinkDeptSecurity",
        ["Warden"] = "SponsorUplinkDeptSecurity",
        ["SecurityOfficer"] = "SponsorUplinkDeptSecurity",
        ["Detective"] = "SponsorUplinkDeptSecurity",
        ["SecurityCadet"] = "SponsorUplinkDeptSecurity",
        ["Brigmedic"] = "SponsorUplinkDeptSecurity",
        ["DutyOfficer"] = "SponsorUplinkDeptSecurity",
        // Cargo
        ["SalvageSpecialist"] = "SponsorUplinkDeptCargo",
        ["MiningSpecialist"] = "SponsorUplinkDeptCargo",
        ["SalvageLead"] = "SponsorUplinkDeptCargo",
        ["Quartermaster"] = "SponsorUplinkDeptCargo",
        ["CargoTechnician"] = "SponsorUplinkDeptCargo",
        ["MailTech"] = "SponsorUplinkDeptCargo",
        ["Bitrunner"] = "SponsorUplinkDeptCargo",
        // Command
        ["Captain"] = "SponsorUplinkDeptCommand",
        ["HeadOfPersonnel"] = "SponsorUplinkDeptCommand",
        // Representatives
        ["NanoTrasenRepresentative"] = "SponsorUplinkDeptRepresentatives",
        ["BlueShield"] = "SponsorUplinkDeptRepresentatives",
        ["Magistrate"] = "SponsorUplinkDeptRepresentatives",
        ["IAA"] = "SponsorUplinkDeptRepresentatives",
        ["NanotrasenCareerTrainer"] = "SponsorUplinkDeptRepresentatives",
        // Engineering
        ["ChiefEngineer"] = "SponsorUplinkDeptEngineering",
        ["TechnicalAssistant"] = "SponsorUplinkDeptEngineering",
        ["StationEngineer"] = "SponsorUplinkDeptEngineering",
        ["AtmosphericTechnician"] = "SponsorUplinkDeptEngineering",
        // Medical
        ["ChiefMedicalOfficer"] = "SponsorUplinkDeptMedical",
        ["Chemist"] = "SponsorUplinkDeptMedical",
        ["MedicalDoctor"] = "SponsorUplinkDeptMedical",
        ["MedicalIntern"] = "SponsorUplinkDeptMedical",
        ["Psychologist"] = "SponsorUplinkDeptMedical",
        ["Paramedic"] = "SponsorUplinkDeptMedical",
        ["Geneticist"] = "SponsorUplinkDeptMedical",
        ["Surgeon"] = "SponsorUplinkDeptMedical",
        // Science
        ["ResearchDirector"] = "SponsorUplinkDeptScience",
        ["Scientist"] = "SponsorUplinkDeptScience",
        ["ResearchAssistant"] = "SponsorUplinkDeptScience",
