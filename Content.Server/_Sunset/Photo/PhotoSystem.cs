...
using Content.Shared._Sunset.Photo;
...
public sealed partial class PhotoSystem : SharedPhotoSystem
{
    ...
    private float _photoTimeRequiredHours = 12;
    ...
    public override void Initialize()
    {
        ...
        Subs.CVar(_cfg, SunsetCCVars.PhotoPlayTimeRequire, value => _photoTimeRequiredEnabled = value, true);
        Subs.CVar(_cfg, SunsetCCVars.PhotoPlayTimeHours, value => _photoTimeRequiredHours = value, true);
    }
