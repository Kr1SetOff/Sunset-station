...
public sealed partial class ZombieSystem
{
    ...
    public void ZombifyEntity(EntityUid target, MobStateComponent? mobState = null)
    {
        ...
        RemComp<Content.Shared._Goobstation.Changeling.Components.ChangelingComponent>(target); //De-lings Changeling zombies
        RemComp<Content.Shared._Goobstation.Changeling.Components.ChangelingIdentityComponent>(target); //De-lings Changeling zombies
