...
using Content.Shared._Goobstation.Slasher.UI;
...
namespace Content.Client._Goobstation.Slasher.UI;
...
public sealed class SlasherKitSelectMenu : FancyWindow
{
    ...
    public SlasherKitSelectMenu()
    {
        ...
        var outerChromeTexture = MakeTexture(new SpriteSpecifier.Rsi(new ResPath("/Textures/_Goobstation/Slasher/Interface/effects.rsi"), "cloud_swirl"), "#ff1744", true);
        ...
        staticSprite.SetFromSpriteSpecifier(new SpriteSpecifier.Rsi(new("_Goobstation/Slasher/Interface/rnd-static.rsi"), "static"));
