...
using Content.Shared._Sunset.Fishing.Components;
...
namespace Content.Client._Sunset.Fishing.Overlays;
...
public sealed class FishingOverlay : Overlay
{
    ...
    public FishingOverlay(IEntityManager entManager, IPlayerManager player)
    {
        ...
        var sprite = new SpriteSpecifier.Rsi(new("/Textures/_Sunset/Interface/Misc/fish_bar.rsi"), "icon");
