...
public sealed partial class PhotoCameraWindow : FancyWindow
{
    ...
    public PhotoCameraWindow()
    {
        ...
        PhotoButton.BaseTexture = new SpriteSpecifier.Texture(new("/Textures/_Sunset/Interface/Misc/Photo/button_base.png"));
        PhotoButton.PointedTexture = new SpriteSpecifier.Texture(new("/Textures/_Sunset/Interface/Misc/Photo/button_highlight.png"));
        PhotoButton.PressedTexture = new SpriteSpecifier.Texture(new("/Textures/_Sunset/Interface/Misc/Photo/button_pressed.png"));
    ...
    public void UpdateState(IEye? eye, bool hasPaper)
    {
        ...
        PaperIndicator.TexturePath = "/Textures/_Sunset/Interface/Misc/Photo/paper_" + (hasPaper ? "on.png" : "off.png");
    }
