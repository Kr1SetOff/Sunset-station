...
job-description-bitrunner = Operate the quantum server, dispatch avatars into virtual domains, and deliver encrypted caches to the byteforge for rewards.
job-name-bitrun-avatar = Bitrunning Avatar
job-description-bitrun-avatar = A neural avatar running inside a bitrunning virtual domain.

id-card-access-level-bitrun = Bitrun
