...
# Possession
possession-fail-target-shielded = Their mind is shielded from your influence!
possession-fail-target-dead = They are too far gone to be worth riding.
possession-fail-ghost = There is nothing there to possess.
possession-fail-target-already-possessed = Something else already rides that body.
possession-popup-others = { CAPITALIZE(THE($target)) } convulses, and something behind their eyes changes.
possession-end-popup = { CAPITALIZE(THE($target)) } collapses as the presence inside them is torn away.
possessed-component-examined = They are being ridden by something. It will leave in { $timeremaining } seconds.

# GunBlocked fallback text
gun-block = You cannot bring yourself to use this weapon.
