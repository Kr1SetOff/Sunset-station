...
ion-storm-law-crew-are = ТЕПЕРЬ { $who } — ЭТО { $joined } { $subjects }.
...
ion-storm-law-having-harmful = ИМЕТЬ { $adjective } { $thing } ВРЕДНО ДЛЯ ЗДОРОВЬЯ ЭКИПАЖА.
ion-storm-law-not-having-harmful = НЕ ИМЕТЬ { $adjective } { $thing } ВРЕДНО ДЛЯ ЗДОРОВЬЯ ЭКИПАЖА.
...
ion-storm-law-crew-must-do = ТОЛЬКО ТЕ, КТО ПЫТАЕТСЯ { $must }, { $part } ЭКИПАЖА.
ion-storm-law-crew-must-have = ТОЛЬКО ТЕ, КТО ИМЕЕТ { $adjective } { $objects }, { $part } ЭКИПАЖА.
