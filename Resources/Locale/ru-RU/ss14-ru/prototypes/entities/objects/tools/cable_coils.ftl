...
ent-CableMVStack = моток СВ проводов
    .desc = СВ кабели для подключения подстанций к ЛКП, а также питания некоторых других устройств, таких как эмиттеры.
    .suffix = Полный
...
ent-CableApcStack = моток НВ проводов
    .desc = Низковольтная стопка проводов для подключения ЛКП к машинам и другим целям.
    .suffix = Полный
