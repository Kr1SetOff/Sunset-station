...
reagent-desc-bromine = Тяжелый красно-коричневый галоген с резким токсичным запахом.

reagent-name-chromium = хром
reagent-desc-chromium = Твердый, блестящий переходный металл с холодным стальным оттенком.
# SS14-Art edit end
