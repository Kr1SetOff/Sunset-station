martial-arts-already-known = Вы уже владеете боевым искусством и не можете выучить ещё одно.
martial-arts-learned = Вы изучили { $style }!

martial-arts-style-ninjutsu = ниндзюцу
martial-arts-style-cqc = CQC
martial-arts-style-cqc-cook = поварской CQC
...
alert-ninjutsu-sneak-lost-name = Скрытность потеряна
alert-ninjutsu-sneak-lost-desc = Вас заметили. Скрытность вернётся через некоторое время без боя.

uplink-martial-arts-capoeira-name = Пособие по капоэйре
uplink-martial-arts-capoeira-desc = Обучает акробатическому боевому стилю капоэйра — уклонения, подсечки и удары в прыжке.

uplink-martial-arts-cqc-name = Устав CQC
uplink-martial-arts-cqc-desc = Обучает технике ближнего боя CQC — захватам, броскам и удушающим приёмам.
