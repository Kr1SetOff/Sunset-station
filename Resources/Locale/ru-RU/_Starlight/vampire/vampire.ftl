...
alerts-vampire-blood-desc = Показывает, сколько крови вы выпили. Выпустите клыки и щёлкните по цели левой кнопкой мыши (без боевого режима) или выберите «Укусить» в меню правой кнопки, чтобы пить.

# 🌇Sunset🌇 - ПКМ-верб питья крови (см. VampireSystem.Sunset.cs)
vampire-verb-drink = Укусить
