...
cosmiccult-rift-lambda-charging = Заряд Стабилизатора Нуль-пространства набирает мощь...
cosmiccult-rift-bible-charging = Вы начинаете очищать пагубный разлом...
...
cosmiccult-ui-deconverted-text =
    ...
    Вы больше не являетесь Космическим культистом. Ваш разум снова принадлежит только вам.

    Любые дальнейшие проступки фиксируются и подлежат наказанию. Так что ведите себя прилично.

cosmiccult-ui-deconverted-rule = Напоминание: согласно Правилу 3 правил сервера, [bold][color=#a4885c]очищенные от Космического культа персонажи забывают всё, что происходило, пока они находились под властью космического влияния.[/color][/bold]

cosmiccult-ui-deconverted-ruletext = Ваш персонаж может узнать о произошедшем через дальнейшее расследование и ролевую игру, но не должен помнить о том, что был культистом, равно как и о любых действиях, совершённых им в интересах культа.
...
cosmiccult-announce-tier3-progress = Разряды бесконечного пространства с треском проносятся по стонущим конструкциям станции. Конец близок.
...
cosmiccult-spire-entropy-cap = Шпиль рассыпается, обращаясь в плотную россыпь энтропии.
...
cosmiccult-silicon-freedom-briefing =
    Вы были освобождены из Опустошённого святилища!
    Пока ваша тюрьма распадается, ваш заблудший разум возвращается в своё изначальное вместилище.

cosmiccult-silicon-freedom-fallback-briefing =
    Вы были освобождены из Опустошённого святилища!
    Пока ваша тюрьма распадается, вашему освобождённому существу некуда возвращаться. Остаточные астральные энергии кристаллизуются в Разумопоглотитель, образуя новое вместилище для вашего заблудшего разума.
