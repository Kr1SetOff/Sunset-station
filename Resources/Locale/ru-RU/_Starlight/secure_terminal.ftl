...
secure-terminal-warops-security-desc = Развёртывает отряд ОБР службы безопасности, специализированный для военных действий. Доступно только во время военных действий.
...
secure-terminal-ert-security-desc = Развёртывает отряд ОБР службы безопасности.
...
secure-terminal-ert-engineering-name = ОБР Инженерный отдел
secure-terminal-ert-engineering-desc = Развёртывает отряд ОБР инженерного отдела для помощи с критически важной инфраструктурой станции.
...
secure-terminal-ert-medical-name = ОБР Медицинский отдел
secure-terminal-ert-medical-desc = Развёртывает медицинский отряд ОБР для массовой сортировки пострадавших и экстренных операций.
...
secure-terminal-ert-janitorial-name = ОБР Хозяйственный отдел
secure-terminal-ert-janitorial-desc = Развёртывает хозяйственный отряд ОБР для устранения опасных загрязнений и восстановления станции.
...
secure-terminal-ert-chaplain-desc = Направляет капеллана ОБР для поддержки морального духа экипажа и проведения последних обрядов.
...
secure-terminal-ert-cburn-name = ОБР CBURN
secure-terminal-ert-cburn-desc = Развёртывает отряд ОБР CBURN.
