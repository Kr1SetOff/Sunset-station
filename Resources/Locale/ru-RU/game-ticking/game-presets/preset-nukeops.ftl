...
nukeops-welcome =
    Вы — ядерный оперативник. Ваша цель — взорвать { $station } и превратить её в груду обломков. Ваши хозяева из Синдиката снабдили вас всем необходимым для выполнения этой задачи.
