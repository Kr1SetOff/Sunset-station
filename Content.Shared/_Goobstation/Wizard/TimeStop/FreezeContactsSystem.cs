...
// Adapted for this fork: dropped the Guardian-host immunity check (Goob-Station's Guardian
// extension isn't ported - the "Magical Lamp" summon it belongs to is out of scope) - anything
// else is frozen the same way.
