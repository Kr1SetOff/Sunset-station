...
// Adapted for this fork: dropped the Shitmed Consciousness/Pain-modifier clearing (life steal no
// longer strips pain sources - this fork has no pain system) and the targetPart/splitDamage args
// off TryChangeDamage (no equivalent here) - life steal still heals the striker proportional to
// damage dealt, it just doesn't also numb them.
