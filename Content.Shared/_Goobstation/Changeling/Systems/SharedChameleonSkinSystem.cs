...
public abstract partial class SharedChameleonSkinSystem : EntitySystem
{
    ...
    {
        // Adapted for this fork: Sunset's StealthComponent has no RevealOnAttack/RevealOnDamage
        // toggles and its StealthOnMoveComponent has no NoMoveTime/BreakOnMove fields - this
        // fork's simpler stealth system always uses its default reveal/move-break behavior.
