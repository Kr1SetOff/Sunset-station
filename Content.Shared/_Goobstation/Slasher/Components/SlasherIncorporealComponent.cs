...
public sealed partial class SlasherIncorporealComponent : Component
{
    ...
    /// <summary>
    /// Movement speed multiplier applied while incorporeal.
    /// </summary>
    [DataField, AutoNetworkedField]
    public float IncorporealSpeedBuff = 5.5f;
    ...
    /// <summary>
    /// Stored fixture collision data so it can be restored on corporealize.
    /// </summary>
    [ViewVariables]
    public int StoredCollisionMask;

    [ViewVariables]
    public int StoredCollisionLayer;
