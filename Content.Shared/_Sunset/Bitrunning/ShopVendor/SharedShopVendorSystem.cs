...
// 🌇Sunset🌇 - ported from Orion-Station-14 (originally DeltaV's ShopVendor). Differences from
// source: the DeltaV mining-points adapter (PointsVendorComponent/MiningPointsSystem) was NOT
// ported - this fork's only shop-vendor currency is bitrunning points, whose adapter lives right
// here (BitrunningPointsVendorComponent + the two event handlers below).
