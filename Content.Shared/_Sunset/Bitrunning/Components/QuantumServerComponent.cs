...
public sealed partial class QuantumServerComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier DomainStartSound = new SoundPathSpecifier("/Audio/_Sunset/Bitrunning/terminal/terminal_processing.ogg");

    [DataField]
    public SoundSpecifier DomainLoadedSound = new SoundPathSpecifier("/Audio/_Sunset/Bitrunning/terminal/terminal_insert_disc.ogg");

    [DataField]
    public SoundSpecifier DomainStopSound = new SoundPathSpecifier("/Audio/_Sunset/Bitrunning/terminal/terminal_off.ogg");

    [DataField]
    public SoundSpecifier DomainAlertSound = new SoundPathSpecifier("/Audio/_Sunset/Bitrunning/terminal/terminal_alert.ogg");

    [DataField]
    public SoundSpecifier ObjectiveRewardSound = new SoundPathSpecifier("/Audio/_Sunset/Bitrunning/terminal/terminal_success.ogg");
}
