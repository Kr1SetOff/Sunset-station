...
/// <summary>
/// One overload effect triggered once the load meter crosses its threshold - see
/// SandevistanUserComponent.Effects and SandevistanSystem.Update.
/// </summary>
...
public sealed partial class SandevistanDisableEffect : SandevistanEffect
{
    ...
    public override void Effect(EntityUid uid, SandevistanUserComponent comp, IEntityManager entityManager, float frameTime)
    {
        ...
        entityManager.System<SharedAudioSystem>().PlayPredicted(OverloadSound, uid, uid);
